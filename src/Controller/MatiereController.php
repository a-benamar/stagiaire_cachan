...
class MatiereController extends AbstractController
{
    ...
    /**
     * @Route("/{idmatiere}", name="app_matiere_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idmatiere}/edit", name="app_matiere_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idmatiere}", name="app_matiere_delete", methods={"POST"})
     */
